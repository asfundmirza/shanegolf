...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: "What features are included in the Toolbox Talk Generator?",
      answer:
        "The Toolbox Talk Generator allows you to quickly create safety talks based on OSHA regulations and customize them for your team's needs.",
    },
    {
      question: "How do I track safety incidents using Safety Chat?",
      answer:
        "Safety Chat includes a Near Miss Tracker that helps you log and follow up on potential hazards, ensuring all safety concerns are documented and addressed.",
    },
    {
      question: "Does Safety Chat comply with OSHA reporting requirements?",
      answer:
        "Yes, Safety Chat includes OSHA 300 Log Input & Reporting, ensuring compliance with federal reporting standards for workplace safety.",
    },
    {
      question: "Can I integrate Safety Chat with other workplace tools?",
      answer:
        "Yes, Safety Chat supports integration with third-party tools and APIs, allowing seamless communication and data flow across platforms.",
    },
    {
      question: "Is there customer support available?",
      answer:
        "Yes, Safety Chat provides 24/7 customer support through chat and email to assist with any issues or questions you may have.",
    },
    {
      question: "How do I get started with Safety Chat?",
      answer:
        "Simply sign up for a free account or choose a paid plan to unlock premium features. You can start using Safety Chat instantly on your mobile or desktop device.",
    },
  ];
        ...
        <div className="mx-auto flex w-full max-w-[81rem] flex-col items-center px-5 py-16 md:px-10 md:py-20">
          <div className="mx-auto flex max-w-xl flex-col items-center justify-center px-6 text-center lg:max-w-3xl lg:px-10">
            ...
            <p className="font-inter mt-4 max-w-xl px-5 text-base font-light text-gray-500 lg:max-w-lg">
              ...
              most frequently asked questions, from privacy measures to using
              the app's features.
            </p>
          </div>

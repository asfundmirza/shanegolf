  ...
  return (
    <>
      <div className="bg-white">
        <div className="max-w-[70rem] px-4 xl:px-0 py-10 mx-auto">
          <div className="border border-green-800 rounded-xl">
            <div className="p-4 lg:p-8 bg-gradient-to-bl from-green-600 via-green-700 to-green-800 rounded-xl">
